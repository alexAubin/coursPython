...
4.0.1 : Écrire une fonction `annee_naissance` qui prends en argument un age et retourne l'année de naissance (+/- 1) sachant que nous sommes ne 2022. Par exemple, `annee_naissance(29)` retounera l'entier `1990`.
